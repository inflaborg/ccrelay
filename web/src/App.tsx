        ...
        <div className="max-w-full px-2 sm:px-4">
          <div className="flex h-10 items-center justify-between">
            ...
            <nav className="flex items-center justify-center">
              <div className="flex">
                <button
                  className={`h-10 px-4 text-xs min-w-[80px] flex items-center justify-center gap-1 rounded-none transition-colors duration-200 ${activeTab === 'dashboard'
                ...
                <button
                  className={`h-10 px-4 text-xs min-w-[80px] flex items-center justify-center gap-1 rounded-none transition-colors duration-200 ${activeTab === 'providers'
                    ? 'bg-primary text-primary-foreground'
                    : 'hover:bg-primary/15'
                    }`}
                ...
                <button
                  className={`h-10 px-4 text-xs min-w-[80px] flex items-center justify-center gap-1 rounded-none transition-colors duration-200 ${activeTab === 'logs'
                    ? 'bg-primary text-primary-foreground'
                    : 'hover:bg-primary/15'
                    }`}
      ...
      <footer className="flex-shrink-0 border-t bg-card px-2 sm:px-4 py-2">
        <div className="max-w-full flex justify-between items-center">
          <p className="text-[11px] text-muted-foreground">
            &copy; 2026 <a href="https://inflab.org" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">inflab.org</a> Project CCRelay
          </p>
